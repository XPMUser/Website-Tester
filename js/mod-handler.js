	...
	initWalkSpeedMod() {
		...
		SystemMenu.prototype.openOther = function() {
			...
			new BitmapFont(this.game, this.content, 0, 280, "walk speed", {
				width: 400,
				align: "center"
			}), this.walkSpeedBar = new ProgressBar(this.game, this.content, 50, 310, 300, 80, 1, this.game.prodigy.player.walkSpeed/20), this.walkSpeedBar.setDraggable(), this.walkSpeedBar.setBarAnimationSpeed(ProgressBar.SPEED_VERYSLOW)
		};
